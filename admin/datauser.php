        ...
        <div id="main">
            ...
            <div class="page-heading">
                <div class="page-title">
                    ...
                    <a href="datauserT.php" class="btn btn-primary mb-1">Tambah Data</a>
                    <div class="col-4">
                            ...
                            <tbody>
                                ...
                                while ($data = mysqli_fetch_assoc($query)) : ?>
                                    <tr>
                                        ...
                                        <td><?= $data['alamat']; ?></td>
                                        <td>
                                            <span class="badge <?= ($data['level'] == 'admin') ? 'bg-success' : 'bg-info' ?>">
                                                <?= $data['level']; ?>
                                            </span>
                                            </td>
                                        <td>
                                            <div class="buttons">
                                                <a href="datauserE.php?id=<?= $data['nip']; ?>" class="btn icon btn-warning"><i class="bi bi-pencil"></i></a>
                                                <a href="datauserH.php?id=<?= $data['nip']; ?>" class="btn icon btn-danger" onclick="return confirm('Anda yakin ingin menghapus?'); "><i class="bi bi-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
