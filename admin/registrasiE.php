...
$nim = $_GET['id'];
$querySelect = $db->query("SELECT * FROM mahasiswa WHERE nim = '$nim'");
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Edit data akun mahasiswa</p>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" id="nohp" class="form-control" name="nohp" value="<?= $data['no_hp']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group mb-3">
