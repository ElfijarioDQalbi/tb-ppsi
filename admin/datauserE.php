...
$id = $_GET['id'];
$querySelect = $db->query("SELECT * FROM petugas WHERE nip = '$id'");
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Mengedit data akun user sistem</p>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" id="nip" class="form-control" name="nip" value="<?= $data['nip']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" id="notelp_ptg" class="form-control" name="notelp_ptg" value="<?= $data['no_hp']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select" id="level" name="level">
                                                ...
                                                <option value="petugas" <?php if ($data['level'] == 'petugas') echo 'selected' ?>>Petugas Fakultas</option>
                                            </select>
                                        </div>
                                    </div>
